...
# Znacznik czasowy: 2024-01-21 14:46:45.932079
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Wno-parentheses -xc -Werror=vla -Wall -Wno-error=parentheses -fmax-errors=5 -Wno-error=unused-parameter -D_GNU_SOURCE -pedantic -Wextra -std=c11 -Wno-error=implicit-fallthrough -fdiagnostics-color -DINSIDE_DANTE -Werror -D_ANSI_OUTPUT -ggdb3 
...
LD          := gcc
LD_FLAGS    := -Wl,-wrap,main -Wl,-cref -Wl,-Map=main.map -ggdb3 
LD_LIBS     := -lm 
...
${OUTDIR}/main: ${OUTDIR}/ajesznutils.c.o ${OUTDIR}/file_reader.c.o ${OUTDIR}/main.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o 
	@echo "Konsolidacja..."
	@${LD} ${LD_FLAGS} ${OUTDIR}/ajesznutils.c.o ${OUTDIR}/file_reader.c.o ${OUTDIR}/main.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o  -o ${OUTDIR}/main ${LD_LIBS}


${OUTDIR}/ajesznutils.c.o:  ajesznutils.c
	@echo "Budowanie pliku 'ajesznutils.o' z 'ajesznutils.c'..."
	${CC} ${CC_FLAGS} -c ajesznutils.c -o ${OUTDIR}/ajesznutils.c.o
